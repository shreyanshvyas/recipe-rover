  ...
  return (
    <div className="w-full h-screen flex font-['Founders_Grotesk_X_Condensed'] text-[#F8FAE5]">
        <div className="flex w-full lg:w-1/2 justify-center items-center bg-[#5e968b] space-y-8 text-[#466e66] font-['Neue_Montreal']">
            ...
            <form className="bg-[#F8FAE5] rounded-md shadow-4xl p-5">
              ...
              <div className="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                ...
                <input id="username" className="bg-[#F8FAE5] text-xl pl-2 w-full outline-none border-none" type="text" name="fullName" placeholder="Your Full Name" />
              </div>
              <div className="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" />
              ...
              <div className="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl ">
                ...
                <input className="pl-2 w-full outline-none border-none bg-[#F8FAE5] text-xl" type="password" name="cpassword" id="cpassword" placeholder="Confirm Password" />
              </div>
        ...
        <div className="relative image w-1/2 flex flex-col">
            ...
            <button className="absolute flex items-center justify-center border rounded-2xl bottom-60 px-10 pb-6 text-4xl pt-6 leading-[.6] bg-[#43766C] uppercase tracking-tight font-['Neue_Montreal']">Login</button>
        </div></div>
